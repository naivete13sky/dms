...
class JobListViewJquery(ListView):
    queryset = models.Job.objects.all()
    # model=models.Job
    context_object_name = 'jobs'
    paginate_by = 10
    # ordering = ['-publish']
    template_name = 'JobListViewJquery.html'
...
class JobUpdateViewCam(UpdateView):
    ...
    def get_form_kwargs_current_page(self):
        # 获取kwargs对象
        kwargs = super(JobUpdateViewCam, self).get_form_kwargs()
        # 传递参数
        current_page = self.kwargs['current_page']
        print("current_page::", current_page)
        return current_page
    ...
    def get_success_url(self):
        return '../../JobListViewCam?page={}'.format(self.get_form_kwargs_current_page())
...
def test_admin(request):
    ...
    return render(request, 'test_admin.html',{"result_json":result_json})
