# Generated by Django 4.0.4 on 2022-08-04 02:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('job_manage', '0007_job_bool_layer_info'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vs_result', models.CharField(blank=True, choices=[('passed', '通过'), ('failed', '失败'), ('none', '未比对')], default='none', max_length=10, null=True, verbose_name='悦谱比对结果')),
