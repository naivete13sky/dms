...
urlpatterns = [
    ...
    path('JobListView0',login_required(views.JobListView0.as_view()),name='JobListView0'),
    ...
    path('JobUpdateView/<int:pk>/<int:current_page>', views.JobUpdateView.as_view(), name='JobUpdateView'),
    ...
    path('vs_ep/<int:job_id>/<int:current_page>', views.vs_ep,name='vs_ep'),
    path('vs_g/<int:job_id>/<int:current_page>', views.vs_g,name='vs_g'),
