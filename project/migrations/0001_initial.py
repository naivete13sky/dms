    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('factory_rule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='project_factory_rule', to='account.factoryrule', verbose_name='厂规')),
