    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recommender', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='account_recommender', to=settings.AUTH_USER_MODEL)),
