...
class CamOrder(models.Model):
    ...
    process_price=MoneyField(max_digits=14, decimal_places=2,null=True, default_currency='Yuan',verbose_name='接单报价')
    process_user=models.ForeignKey(User, on_delete=models.CASCADE, related_name='cam_order_process_user',verbose_name="接单人")
